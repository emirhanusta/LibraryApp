...
public class PublisherController {
    ...
    @NotNull
    public ResponseEntity<Page<PublisherResponse>> findAll(@NotNull final Pageable pageable) {
    ...
    @NotNull
    public ResponseEntity<Page<PublisherWithBooksResponse>> findPublishersWithBooks(
